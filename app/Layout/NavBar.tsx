...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      "relative z-10 border rounded-xl flex max-w-max flex-1 items-center justify-center",
      className
    )}
    {...props}
  >
...
const Nav = () => {
  ...
  return (
    <CardWrapper>
      <nav className="fixed top-0 left-0 z-50 flex w-full items-center justify-between text-white p-4">
        <button
        ...
        >
          ...
          <p className="font-black text-lg">Banking App 1.0</p>
        </button>
        <NavigationMenu>
          <NavigationMenuList>
            {navbarTabs.map((tab) => (
