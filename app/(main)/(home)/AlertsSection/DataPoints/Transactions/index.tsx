...
const Transactions = (): ReactElement => {
  return (
    <div className="relative grid h-full w-full grid-cols-1 grid-rows-7 gap-2 sm:grid-cols-5 place-items-center">
      <div className="absolute left-0 top-20 w-2/3">
        <Header highlightedText="Your Transactions" size="sm" />
        <TransactionsTable transactions={transactionMockData} />
      </div>
      <div className="absolute right-0 top-60 w-2/3">
        <Header
