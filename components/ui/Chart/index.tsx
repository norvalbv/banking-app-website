...
>(({ active, payload, className, hideIndicator = false, label, color }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-neutral-200 bg-white px-3 py-2 text-sm shadow-md dark:border-neutral-800 dark:bg-neutral-950',
        className
      )}
    >
